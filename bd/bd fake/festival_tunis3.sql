...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 28 oct. 2024 à 05:45
...
(2, 4, '2024-10-05', '15:20:00', 'BOUAKE'),
(3, 5, '2025-01-02', '15:20:00', 'MAN'),
(4, 4, '2024-10-05', '15:23:00', 'aBIDJAN'),
(5, 5, '2024-10-13', '17:20:00', 'MAN'),
(6, 2, '2025-01-13', '15:24:00', 'BOUAKE');
...
--
ALTER TABLE `projectionfilm`
  MODIFY `idProjection` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
